...
\section{Conclusão}
O documento atende a todos os requisitos solicitados:
\begin{itemize}
\item Formato A4 (210 x 297 mm)
\item Título centralizado
\item Lista de autores listados abaixo do título conforme margem direita
\item Fonte tamanho 12 para o texto e tamanho 10 para as citações longas diretas ou nas notas de rodapés
\item Numeração no canto superior direito, a 2 cm da borda do papel com algarismos arábicos e tamanho da fonte menor
\item Na primeira página não leva número, mas é contada
\item Espaçamento entre as linhas é de 1,5 cm
\item Notas de rodapé, citações textuais de mais de três linhas com espaçamento simples
\item Sem espaçamento entre parágrafos
\end{itemize}
